            ...
            <div class="panel-body">
                <div class="bootstrap-table">
                    <table class="table table-bordered">
                        <thead>
                            <tr class="bg-primary">
                                <th style="width:20%">Tên Đơn Hàng</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $order->total }}</td>
                                <td>
                                    <a href="{{route('orders.show',[$order->id])}}" class="btn btn-warning"><i
                                            class="fas fa-th-list" title="Xem"></i></a>
                                    <form action="{{route('orders.destroy',$order->id)}}" method="post"
                                        style="display:inline" title="Xóa">
                                        @csrf
                                        @method('delete')
